...
const load = Vue.createApp({
  setup () {
    return {
      CarouselText1: 'WELCOME TO NEW LIFE ROLEPLAY.',
      CarouselSubText1: 'Developed by: MOUHA#1616',
      CarouselText2: 'OWENRS MOUHA / ABDOU .',
      CarouselSubText2: 'BEST ROLEPLAY',
      CarouselText3: 'BEST ADMIN.',
      CarouselSubText3: 'NEW LIFE  ',
      CarouselText4: 'For additional support please join our community at https://discord.gg/8yZ4p69utC',
      CarouselSubText4: 'GO GO',
